...
///
/// ```rust
/// let url = xix_svgconverter_lib::xstr!("https://svg.new/api/image/vectorize");
/// assert_eq!(
///     xix_svgconverter_lib::secure::strings::decrypt(url, xix_svgconverter_lib::secure::strings::XKEY),
